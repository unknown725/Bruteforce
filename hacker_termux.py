...
def brute_force_password(wordlist, target_username):
    ...
    # Limit the attempts to 15000
    for password in wordlist[:15000]:  # Take only the first 15000 passwords
    ...
    print(f'Password not found in the wordlist after {attempts} attempts.')
...
if __name__ == "__main__":  # Corrected to use double underscores
    ...
    if not os.path.isfile(args.wordlist):
        ...
        brute_force_password(wordlist, args.target_username)  # Correct function call00
